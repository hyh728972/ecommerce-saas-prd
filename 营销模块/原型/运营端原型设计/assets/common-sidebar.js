...
(function (global) {
  ...
  // 营销模块提取版：仅积分2.0目录存在的页面保留真实链接，其余页面以 # 占位（见售后模块-V1.4 同款处理）
  var NAV_SECTIONS = [
    {
      id: 'home',
      type: 'item',
    ...
    },
    {
      label: '选品管理',
      items: [
        { id: 'supply-pool', label: '供应链商品池', href: '#', icon: 'grid' },
        { id: 'selection-list', label: '选品清单管理', href: '#', icon: 'search' },
        { id: 'pending-selection', label: '待处理选品', href: '#', icon: 'pending', badge: '8' },
        { id: 'channel-products', label: '渠道商品管理', href: '#', icon: 'channel' },
        { id: 'jicai-products', label: '集采商品列表', href: '#', icon: 'combo' }
      ]
    },
    {
      label: '运营配置',
      items: [
        ...
        { id: 'product-tag', label: '商城标签管理', href: '#', icon: 'tag' },
        { id: 'product-brand', label: '商品品牌列表', href: '#', icon: 'brand' }
      ]
    },
    {
      label: '商城装修',
      items: [
        { id: 'page-template', label: '页面模板管理', href: '#', icon: 'template' },
        { id: 'asset-library', label: '素材库', href: '#', icon: 'folder' }
      ]
    },
    {
      label: '积分卡券',
    ...
    },
    {
      label: '订单监控',
      items: [
        { id: 'order-list', label: '商城订单列表', href: '#', icon: 'order' },
        { id: 'order-config', label: '订单交易配置', href: '#', icon: 'settings' },
        { id: 'payment-config', label: '积分抵扣配置', href: '#', icon: 'credit-card' },
        { id: 'jicai-quotes', label: '集采报价管理', href: '#', icon: 'file-text' },
        { id: 'jicai-orders', label: '集采订单列表', href: '#', icon: 'order' }
      ]
    },
    {
      label: '售后管理',
      items: [
        ...
        { id: 'cs-ticket-list', label: '客服工单列表', href: '#', icon: 'headset' }
      ]
    },
    {
      label: '渠道管理',
      items: [
        { id: 'enterprise-customer', label: '企业客户列表', href: '#', icon: 'customer' },
        { id: 'brand-mall', label: '品牌商城列表', href: '#', icon: 'mall' },
        { id: 'channel-user-list', label: '渠道用户列表', href: '#', icon: 'share' }
      ]
    },
    {
      label: '协同管理',
      items: [
        { id: 'approval-management', label: '商城审批管理', href: '#', icon: 'clipboard-check' },
        { id: 'notification-config', label: '消息通知配置', href: '#', icon: 'bell' },
        { id: 'sensitive-word', label: '敏感词库管理', href: '#', icon: 'activity' }
      ]
    },
    {
      label: '基础配置',
      items: [
        { id: 'pay-config', label: '支付配置', href: '#', icon: 'wallet' },
        { id: 'express-config', label: '快递配置', href: '#', icon: 'send' },
        { id: 'wecom-config', label: '企微配置', href: '#', icon: 'customer' },
        { id: 'cs-config', label: '客服配置', href: '#', icon: 'headset' }
      ]
    },
    {
      label: '系统设置',
      items: [
        { id: 'agreement', label: '协议管理', href: '#', icon: 'file-text' },
