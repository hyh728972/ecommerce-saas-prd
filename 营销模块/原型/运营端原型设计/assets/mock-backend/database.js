...
const MallDB = {
  ...
  // ============================================================
  supplyProducts: [
    { id:101, name:'3M 9001V KN95口罩', model:'9001V', spec:'白色,常规', spu:'ZD-A00001', sku:'HZ-A00001-001-DF', jc:true, jcPrice:'¥15.80', jcMoq:100, type:'physical', catL3:'劳保用品 > 防护口罩 > KN95口罩', brand:'3M', supplier:'星辰商贸', tags:[0,2,4], supplyPrice:'¥17.50', ecomPrice:'¥39.90', stock:5000, warehouse:'华东仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-06-20 08:30', preferred:true },
    { id:102, name:'3M 9001V KN95口罩', model:'9001V', spec:'白色,常规', spu:'ZD-A00001', sku:'HZ-A00001-002-DF', jc:true, jcPrice:'¥15.20', jcMoq:100, type:'physical', catL3:'劳保用品 > 防护口罩 > KN95口罩', brand:'3M', supplier:'恒通供应链', tags:[0,4], supplyPrice:'¥16.80', ecomPrice:'¥36.90', stock:8000, warehouse:'华南仓', shipping:'京东物流', logisticsNote:'48h内发货', createdAt:'2025-06-21 14:20' },
    { id:103, name:'OPPO Find X8', model:'Find X8', spec:'星野黑,12+256GB', spu:'ZD-B00003', sku:'HZ-B00003-001-DF', jc:true, jcPrice:'¥3,850.00', jcMoq:10, type:'physical', catL3:'数码 > 手机通讯 > 智能手机', brand:'OPPO', supplier:'OPPO官方旗舰店', tags:[0,1,2], supplyPrice:'¥3,999.00', ecomPrice:'¥4,299.00', stock:500, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'1天内发货', createdAt:'2025-06-25 09:00', preferred:true },
    { id:104, name:'不锈钢保温杯500ml', model:'CUP-330', spec:'银色,500ml', spu:'ZD-A00004', sku:'HZ-A00004-001-DF', jc:true, jcPrice:'¥31.00', jcMoq:60, type:'physical', catL3:'家居 > 杯具 > 保温杯', brand:'富光', supplier:'星辰商贸', tags:[2,3], supplyPrice:'¥34.50', ecomPrice:'¥68.00', stock:5200, warehouse:'华中仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-01-10 16:00' },
    { id:105, name:'加厚保暖羽绒服', model:'DOWN-401', spec:'黑色,M', spu:'ZD-A00008', sku:'HZ-A00008-001-DF', jc:true, jcPrice:'¥165.00', jcMoq:30, type:'physical', catL3:'男装 > 外套 > 羽绒服', brand:'波司登', supplier:'环球优选', tags:[0,5], supplyPrice:'¥180.00', ecomPrice:'¥359.00', stock:320, warehouse:'华北仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-05-20 11:45' },
    { id:106, name:'男士商务休闲皮鞋', model:'SHOE-552', spec:'黑色,41码', spu:'ZD-A00006', sku:'HZ-A00006-001-DF', type:'physical', catL3:'鞋靴 > 男鞋 > 商务鞋', brand:'奥康', supplier:'恒通供应链', tags:[2,4], supplyPrice:'¥100.00', ecomPrice:'¥259.00', stock:0, warehouse:'华东仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-02-28 08:30' },
    { id:107, name:'4K超清智能投影仪', model:'PROJ-120', spec:'标准版', spu:'ZD-A00007', sku:'HZ-A00007-001-DF', type:'physical', catL3:'数码 > 投影设备 > 智能投影仪', brand:'极米', supplier:'鹏程优品', tags:[0,1,2], supplyPrice:'¥520.00', ecomPrice:'¥899.00', stock:156, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-01 13:00', preferred:true },
    { id:108, name:'在线教育VIP年卡', model:'EDU-VIP-12M', spec:'12个月', spu:'ZDXN-A00001', sku:'HZXN-A00001-001-KM', type:'virtual', catL3:'虚拟商品 > 教育 > 会员卡', brand:'学而思', supplier:'数字服务商A', tags:[1,5], supplyPrice:'¥199.00', ecomPrice:'¥365.00', stock:-1, warehouse:'—', shipping:'自动发货', logisticsNote:'即时到账', createdAt:'2025-04-18 10:00' },
    { id:109, name:'视频平台会员季卡', model:'VIDEO-VIP-3M', spec:'季卡', spu:'ZDXN-A00002', sku:'HZXN-A00002-001-ZC', type:'virtual', catL3:'虚拟商品 > 影音娱乐 > 会员卡', brand:'腾讯视频', supplier:'数字服务商B', tags:[5], supplyPrice:'¥45.00', ecomPrice:'¥78.00', stock:-1, warehouse:'—', shipping:'自动发货', logisticsNote:'即时到账', createdAt:'2025-04-20 15:30' },
    { id:110, name:'云存储空间1TB/年', model:'CLOUD-1T-Y', spec:'1TB', spu:'ZDXN-A00003', sku:'HZXN-A00003-001-ZC', type:'virtual', catL3:'虚拟商品 > 云服务 > 存储', brand:'阿里云', supplier:'数字服务商A', tags:[2,3], supplyPrice:'¥88.00', ecomPrice:'¥158.00', stock:-1, warehouse:'—', shipping:'自动开通', logisticsNote:'即时生效', createdAt:'2025-03-05 09:00' },
    { id:111, name:'无线降噪蓝牙耳机', model:'BUD-990', spec:'黑色', spu:'ZD-A00010', sku:'HZ-A00010-001-DF', jc:true, jcPrice:'¥122.00', jcMoq:50, type:'physical', catL3:'数码 > 音频设备 > 蓝牙耳机', brand:'漫步者', supplier:'星辰商贸', tags:[0,2,4], supplyPrice:'¥135.00', ecomPrice:'¥269.00', stock:4320, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-05-10 14:15' },
    { id:112, name:'电子书阅读器青春版', model:'EREAD-7', spec:'黑色,6英寸', spu:'ZD-A00011', sku:'HZ-A00011-001-DF', type:'physical', catL3:'数码 > 阅读设备 > 电子书', brand:'掌阅', supplier:'恒通供应链', tags:[1,3], supplyPrice:'¥220.00', ecomPrice:'¥399.00', stock:0, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-05-15 10:45' },
    { id:113, name:'户外防水冲锋衣', model:'JKT-880', spec:'藏青,L', spu:'ZD-A00012', sku:'HZ-A00012-001-DF', jc:true, jcPrice:'¥238.00', jcMoq:20, type:'physical', catL3:'男装 > 外套 > 冲锋衣', brand:'探路者', supplier:'环球优选', tags:[0,3,4], supplyPrice:'¥260.00', ecomPrice:'¥499.00', stock:1200, warehouse:'华北仓', shipping:'顺丰/京东', logisticsNote:'24h内发货', createdAt:'2025-06-05 16:30' },
    { id:114, name:'女士防晒皮肤衣', model:'UV-335', spec:'樱花粉,均码', spu:'ZD-A00013', sku:'HZ-A00013-001-DF', type:'physical', catL3:'女装 > 外套 > 防晒衣', brand:'蕉下', supplier:'鹏程优品', tags:[0,1], supplyPrice:'¥72.00', ecomPrice:'¥149.00', stock:6800, warehouse:'华东仓', shipping:'中通/韵达', logisticsNote:'24h内发货', createdAt:'2025-06-12 08:00' },
    { id:115, name:'智能手表GT4', model:'WATCH-GT4', spec:'46mm,幻夜黑', spu:'ZD-A00014', sku:'HZ-A00014-001-DF', type:'physical', catL3:'数码 > 穿戴设备 > 智能手表', brand:'华为', supplier:'星辰商贸', tags:[0,1,2], supplyPrice:'¥680.00', ecomPrice:'¥1288.00', stock:450, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-18 11:20' },
    { id:116, name:'有机山茶油500ml', model:'OIL-021', spec:'500ml', spu:'ZD-A00015', sku:'HZ-A00015-001-DF', jc:true, jcPrice:'¥25.50', jcMoq:200, type:'physical', catL3:'家居 > 食品 > 食用油', brand:'金龙鱼', supplier:'恒通供应链', tags:[3,4], supplyPrice:'¥28.00', ecomPrice:'¥59.00', stock:15000, warehouse:'华中仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-02-10 09:45' },
    { id:117, name:'电子礼品卡100元', model:'GIFT-100', spec:'100元面值', spu:'ZDXN-A00004', sku:'HZXN-A00004-001-KM', type:'virtual', catL3:'虚拟商品 > 礼品卡 > 电子卡', brand:'京东', supplier:'数字服务商B', tags:[5], supplyPrice:'¥90.00', ecomPrice:'¥100.00', stock:-1, warehouse:'—', shipping:'自动发放', logisticsNote:'即时到账', createdAt:'2025-03-22 13:30' },
    { id:118, name:'男士速干运动短裤', model:'SHORT-662', spec:'黑色,XL', spu:'ZD-A00016', sku:'HZ-A00016-001-DF', type:'physical', catL3:'男装 > 裤子 > 运动裤', brand:'安踏', supplier:'环球优选', tags:[0,3], supplyPrice:'¥48.00', ecomPrice:'¥99.00', stock:3800, warehouse:'华北仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-05-28 10:00' },
    { id:119, name:'家用空气净化器', model:'AIR-P300', spec:'白色', spu:'ZD-A00017', sku:'HZ-A00017-001-DF', type:'physical', catL3:'家居 > 电器 > 净化器', brand:'美的', supplier:'鹏程优品', tags:[0,1,4], supplyPrice:'¥420.00', ecomPrice:'¥799.00', stock:0, warehouse:'华东仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-08 15:00' },
    { id:120, name:'真皮手提商务包', model:'BAG-881', spec:'黑色', spu:'ZD-A00018', sku:'HZ-A00018-001-DF', jc:true, jcPrice:'¥160.00', jcMoq:20, type:'physical', catL3:'鞋靴 > 箱包 > 商务包', brand:'金利来', supplier:'星辰商贸', tags:[2,3,4], supplyPrice:'¥175.00', ecomPrice:'¥359.00', stock:560, warehouse:'华南仓', shipping:'顺丰/京东', logisticsNote:'24h内发货', createdAt:'2025-04-25 14:00' },
    { id:121, name:'音乐平台会员年卡', model:'MUSIC-VIP-Y', spec:'年卡', spu:'ZDXN-A00005', sku:'HZXN-A00005-001-ZC', type:'virtual', catL3:'虚拟商品 > 影音娱乐 > 会员卡', brand:'网易云音乐', supplier:'数字服务商A', tags:[5], supplyPrice:'¥68.00', ecomPrice:'¥128.00', stock:-1, warehouse:'—', shipping:'自动发货', logisticsNote:'即时到账', createdAt:'2025-04-28 11:00' },
    { id:122, name:'女士帆布休闲鞋', model:'CANVAS-112', spec:'白色,37码', spu:'ZD-A00019', sku:'HZ-A00019-001-DF', jc:true, jcPrice:'¥34.50', jcMoq:80, type:'physical', catL3:'鞋靴 > 女鞋 > 帆布鞋', brand:'回力', supplier:'恒通供应链', tags:[0,2,3], supplyPrice:'¥38.00', ecomPrice:'¥79.00', stock:9600, warehouse:'华中仓', shipping:'中通/韵达', logisticsNote:'24h内发货', createdAt:'2025-03-18 08:30' },
    { id:123, name:'便携式蓝牙音箱', model:'SPK-550', spec:'黑色', spu:'ZD-A00020', sku:'HZ-A00020-001-DF', type:'physical', catL3:'数码 > 音频设备 > 蓝牙音箱', brand:'JBL', supplier:'鹏程优品', tags:[0,1,5], supplyPrice:'¥155.00', ecomPrice:'¥299.00', stock:780, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-15 16:00' },
    { id:124, name:'有机绿茶礼盒装', model:'TEA-200', spec:'250g礼盒', spu:'ZD-A00021', sku:'HZ-A00021-001-DF', jc:true, jcPrice:'¥51.00', jcMoq:50, type:'physical', catL3:'家居 > 食品 > 茶叶', brand:'八马', supplier:'环球优选', tags:[2,4], supplyPrice:'¥56.00', ecomPrice:'¥128.00', stock:3400, warehouse:'华东仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-03-30 09:30' },
    { id:125, name:'儿童防蓝光眼镜', model:'GLASS-K01', spec:'蓝,通用', spu:'ZD-A00022', sku:'HZ-A00022-001-DF', type:'physical', catL3:'家居 > 眼镜 > 防蓝光镜', brand:'可得', supplier:'星辰商贸', tags:[1,4], supplyPrice:'¥62.00', ecomPrice:'¥139.00', stock:2100, warehouse:'华北仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-05-05 10:15' },
    // SKU variants — 丰富案例
    { id:126, name:'不锈钢保温杯500ml', model:'CUP-330', spec:'黑色,500ml', spu:'ZD-A00004', sku:'HZ-A00004-002-DF', jc:true, jcPrice:'¥32.50', jcMoq:60, type:'physical', catL3:'家居 > 杯具 > 保温杯', brand:'富光', supplier:'星辰商贸', tags:[2,3], supplyPrice:'¥36.00', ecomPrice:'¥72.00', stock:3100, warehouse:'华中仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-01-12 09:00' },
    { id:127, name:'不锈钢保温杯500ml', model:'CUP-330', spec:'白色,500ml', spu:'ZD-A00004', sku:'HZ-A00004-003-DF', jc:true, jcPrice:'¥30.00', jcMoq:60, type:'physical', catL3:'家居 > 杯具 > 保温杯', brand:'富光', supplier:'鹏程优品', tags:[3], supplyPrice:'¥33.00', ecomPrice:'¥65.00', stock:1800, warehouse:'华南仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-02-20 14:30' },
    { id:128, name:'加厚保暖羽绒服', model:'DOWN-401', spec:'黑色,L', spu:'ZD-A00008', sku:'HZ-A00008-002-DF', type:'physical', catL3:'男装 > 外套 > 羽绒服', brand:'波司登', supplier:'环球优选', tags:[0,5], supplyPrice:'¥190.00', ecomPrice:'¥379.00', stock:180, warehouse:'华北仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-05-22 08:20' },
    { id:129, name:'加厚保暖羽绒服', model:'DOWN-401', spec:'黑色,XL', spu:'ZD-A00008', sku:'HZ-A00008-003-DF', jc:true, jcPrice:'¥160.00', jcMoq:30, type:'physical', catL3:'男装 > 外套 > 羽绒服', brand:'波司登', supplier:'恒通供应链', tags:[0], supplyPrice:'¥175.00', ecomPrice:'¥349.00', stock:250, warehouse:'华东仓', shipping:'顺丰/京东', logisticsNote:'24h内发货', createdAt:'2025-06-01 16:10' },
    { id:130, name:'加厚保暖羽绒服', model:'DOWN-401', spec:'藏青,XXL', spu:'ZD-A00008', sku:'HZ-A00008-004-DF', type:'physical', catL3:'男装 > 外套 > 羽绒服', brand:'波司登', supplier:'环球优选', tags:[5], supplyPrice:'¥200.00', ecomPrice:'¥399.00', stock:95, warehouse:'华北仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-10 11:00' },
    { id:131, name:'OPPO Find X8', spec:'漫步云端,12+256GB', model:'Find X8', spu:'ZD-B00003', sku:'HZ-B00003-002-DF', type:'physical', catL3:'数码 > 手机通讯 > 智能手机', brand:'OPPO', supplier:'OPPO官方旗舰店', tags:[0,1], supplyPrice:'¥3,999.00', ecomPrice:'¥4,299.00', stock:320, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'1天内发货', createdAt:'2025-06-25 14:00' },
    { id:132, name:'OPPO Find X8', spec:'星野黑,16+256GB', model:'Find X8', spu:'ZD-B00003', sku:'HZ-B00003-003-DF', type:'physical', catL3:'数码 > 手机通讯 > 智能手机', brand:'OPPO', supplier:'OPPO官方旗舰店', tags:[0,1,2], supplyPrice:'¥4,599.00', ecomPrice:'¥4,999.00', stock:200, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'2天内发货', createdAt:'2025-06-26 10:30', preferred:true },
    { id:141, name:'OPPO Find X8', spec:'漫步云端,16+512GB', model:'Find X8', spu:'ZD-B00003', sku:'HZ-B00003-004-DF', type:'physical', catL3:'数码 > 手机通讯 > 智能手机', brand:'OPPO', supplier:'OPPO官方旗舰店', tags:[0,1], supplyPrice:'¥4,599.00', ecomPrice:'¥4,999.00', stock:150, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'2天内发货', createdAt:'2025-06-26 16:00' },
    { id:142, name:'OPPO Find X8', spec:'星野黑,16+1TB', model:'Find X8', spu:'ZD-B00003', sku:'HZ-B00003-005-DF', type:'physical', catL3:'数码 > 手机通讯 > 智能手机', brand:'OPPO', supplier:'OPPO官方旗舰店', tags:[0], supplyPrice:'¥5,299.00', ecomPrice:'¥5,999.00', stock:80, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'3天内发货', createdAt:'2025-06-27 08:00', preferred:true },
    { id:133, name:'无线降噪蓝牙耳机', model:'BUD-990', spec:'白色', spu:'ZD-A00010', sku:'HZ-A00010-002-DF', type:'physical', catL3:'数码 > 音频设备 > 蓝牙耳机', brand:'漫步者', supplier:'星辰商贸', tags:[0,2], supplyPrice:'¥140.00', ecomPrice:'¥279.00', stock:2100, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-05-12 09:00' },
    { id:134, name:'无线降噪蓝牙耳机', model:'BUD-990', spec:'白色', spu:'ZD-A00010', sku:'HZ-A00010-003-DF', type:'physical', catL3:'数码 > 音频设备 > 蓝牙耳机', brand:'漫步者', supplier:'鹏程优品', tags:[2,4], supplyPrice:'¥128.00', ecomPrice:'¥259.00', stock:890, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-05-18 14:20' },
    { id:135, name:'无线降噪蓝牙耳机', model:'BUD-990', spec:'蓝色', spu:'ZD-A00010', sku:'HZ-A00010-004-DF', type:'physical', catL3:'数码 > 音频设备 > 蓝牙耳机', brand:'漫步者', supplier:'星辰商贸', tags:[0,4], supplyPrice:'¥145.00', ecomPrice:'¥289.00', stock:560, warehouse:'华北仓', shipping:'中通/京东', logisticsNote:'24h内发货', createdAt:'2025-06-05 16:30', preferred:true },
    { id:136, name:'4K超清智能投影仪', model:'PROJ-120', spec:'Pro增强版', spu:'ZD-A00007', sku:'HZ-A00007-002-DF', type:'physical', catL3:'数码 > 投影设备 > 智能投影仪', brand:'极米', supplier:'恒通供应链', tags:[0,1,2], supplyPrice:'¥580.00', ecomPrice:'¥999.00', stock:88, warehouse:'华南仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-05 11:30', preferred:true },
    { id:137, name:'男士商务休闲皮鞋', model:'SHOE-552', spec:'棕色,42码', spu:'ZD-A00006', sku:'HZ-A00006-002-DF', type:'physical', catL3:'鞋靴 > 男鞋 > 商务鞋', brand:'奥康', supplier:'星辰商贸', tags:[2,4], supplyPrice:'¥105.00', ecomPrice:'¥269.00', stock:350, warehouse:'华东仓', shipping:'顺丰', logisticsNote:'24h内发货', createdAt:'2025-03-05 15:00', preferred:true },
    { id:138, name:'男士商务休闲皮鞋', model:'SHOE-552', spec:'棕色,43码', spu:'ZD-A00006', sku:'HZ-A00006-003-DF', type:'physical', catL3:'鞋靴 > 男鞋 > 商务鞋', brand:'奥康', supplier:'恒通供应链', tags:[4], supplyPrice:'¥98.00', ecomPrice:'¥249.00', stock:120, warehouse:'华南仓', shipping:'京东物流', logisticsNote:'48h内发货', createdAt:'2025-03-08 09:30' },
    { id:139, name:'真皮手提商务包', model:'BAG-881', spec:'棕色', spu:'ZD-A00018', sku:'HZ-A00018-002-DF', type:'physical', catL3:'鞋靴 > 箱包 > 商务包', brand:'金利来', supplier:'星辰商贸', tags:[2,3,4], supplyPrice:'¥180.00', ecomPrice:'¥369.00', stock:280, warehouse:'华南仓', shipping:'顺丰/京东', logisticsNote:'24h内发货', createdAt:'2025-04-28 10:00', preferred:true },
    { id:140, name:'家用空气净化器', model:'AIR-P300', spec:'灰色', spu:'ZD-A00017', sku:'HZ-A00017-002-DF', type:'physical', catL3:'家居 > 电器 > 净化器', brand:'美的', supplier:'环球优选', tags:[0,1], supplyPrice:'¥430.00', ecomPrice:'¥829.00', stock:180, warehouse:'华东仓', shipping:'顺丰', logisticsNote:'48h内发货', createdAt:'2025-06-10 10:00' },
    { id:201, name:"3M防护标准套装", model:"COMBO-001", spec:"标准套装", spu:"ZDZH-A00001", sku:"HZZH-A00001-001", type:"combo", catL3:"劳保用品 > 防护口罩 > KN95口罩", brand:"3M", supplier:"星辰商贸", tags:[0,2], supplyPrice:"¥40.00", ecomPrice:"¥39.90", stock:1200, comboComponents:[{role:"主件",qty:1,name:"3M 9001V KN95口罩"},{role:"搭配件",qty:1,name:"3M护目镜 防雾防尘"}], warehouse:"华东仓", shipping:"顺丰/中通", logisticsNote:"24h内发货", createdAt:"2026-06-20 10:00", preferred:true },
    { id:202, name:"夏季清凉防护礼包", model:"GIFT-001", spec:"买赠:3M口罩+赠品×3", spu:"ZD-A00001", sku:"HZZH-A00002-001", type:"gift", catL3:"劳保用品 > 防护口罩 > KN95口罩", brand:"3M", supplier:"恒通供应链", tags:[0], supplyPrice:"¥25.00", ecomPrice:"¥59.00", stock:800, warehouse:"华南仓", shipping:"京东物流", logisticsNote:"48h内发货", createdAt:"2026-06-22 14:30", comboComponents:[{role:"主件",qty:1,name:"3M 9001V KN95口罩"},{role:"赠品",qty:2,name:"舒肤佳湿巾 80抽"}] },
    // —— 主流程补齐:选品清单/待处理队列引用但池内缺失的商品回填主数据(含一品多商跟卖行) ——
    { id:143, name:'夏季纯棉圆领T恤', model:'TSHIRT-002', spec:'白色,M', spu:'ZD-A00009', sku:'HZ-A00009-001-DF', type:'physical', catL3:'男装 > T恤 > 短袖T恤', brand:'森马', supplier:'星辰商贸', tags:[0,1,2], supplyPrice:'¥85.00', ecomPrice:'¥129.00', stock:2580, warehouse:'华东仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-04-10 09:00', preferred:true },
    { id:144, name:'夏季纯棉圆领T恤', model:'TSHIRT-002', spec:'白色,M', spu:'ZD-A00009', sku:'HZ-A00009-002-DF', type:'physical', catL3:'男装 > T恤 > 短袖T恤', brand:'森马', supplier:'恒通供应链', tags:[0,2], supplyPrice:'¥82.00', ecomPrice:'¥125.00', stock:1900, warehouse:'华北仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-04-12 11:20' },
    { id:145, name:'智能蓝牙体脂秤', model:'SCALE-087', spec:'白色', spu:'ZD-A00003', sku:'HZ-A00003-001-DF', type:'physical', catL3:'数码 > 健康设备 > 体脂秤', brand:'小米', supplier:'恒通供应链', tags:[0,3], supplyPrice:'¥95.00', ecomPrice:'¥189.00', stock:890, warehouse:'华南仓', shipping:'京东物流', logisticsNote:'48h内发货', createdAt:'2025-03-12 10:30', preferred:true },
    { id:146, name:'智能蓝牙体脂秤', model:'SCALE-087', spec:'白色', spu:'ZD-A00003', sku:'HZ-A00003-002-DF', type:'physical', catL3:'数码 > 健康设备 > 体脂秤', brand:'小米', supplier:'星辰商贸', tags:[0,3], supplyPrice:'¥90.00', ecomPrice:'¥189.00', stock:1200, warehouse:'华东仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-03-15 14:00' },
    { id:147, name:'智能蓝牙体脂秤', model:'SCALE-087', spec:'白色', spu:'ZD-A00003', sku:'HZ-A00003-003-DF', type:'physical', catL3:'数码 > 健康设备 > 体脂秤', brand:'小米', supplier:'鹏程优品', tags:[3], supplyPrice:'¥102.00', ecomPrice:'¥199.00', stock:600, warehouse:'华南仓', shipping:'京东物流', logisticsNote:'48h内发货', createdAt:'2025-03-18 09:40' },
    { id:148, name:'女士直筒休闲长裤', model:'PANT-228', spec:'黑色,均码', spu:'ZD-A00005', sku:'HZ-A00005-001-DF', type:'physical', catL3:'女装 > 裤子 > 休闲裤', brand:'优衣库', supplier:'鹏程优品', tags:[1,4], supplyPrice:'¥95.00', ecomPrice:'¥169.00', stock:0, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'供应商已下架', createdAt:'2025-02-14 15:30', preferred:true },
    { id:149, name:'女士直筒休闲长裤', model:'PANT-228', spec:'黑色,均码', spu:'ZD-A00005', sku:'HZ-A00005-002-DF', type:'physical', catL3:'女装 > 裤子 > 休闲裤', brand:'优衣库', supplier:'恒通供应链', tags:[1], supplyPrice:'¥88.00', ecomPrice:'¥159.00', stock:520, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-02-18 10:10' },
    { id:150, name:'有机山茶油500ml', model:'OIL-021', spec:'500ml', spu:'ZD-A00015', sku:'HZ-A00015-002-DF', type:'physical', catL3:'家居 > 食品 > 食用油', brand:'金龙鱼', supplier:'星辰商贸', tags:[3,4], supplyPrice:'¥27.00', ecomPrice:'¥59.00', stock:8000, warehouse:'华中仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-02-25 09:00' },
    { id:151, name:'新疆纯牛奶200ml*12', model:'MILK-2012', spec:'200ml*12盒', spu:'ZD-A00023', sku:'HZ-A00023-001-DF', jc:true, jcPrice:'¥41.00', jcMoq:100, type:'physical', catL3:'家居 > 食品 > 乳制品', brand:'天润', supplier:'恒通供应链', tags:[3,4], supplyPrice:'¥45.00', ecomPrice:'¥79.00', stock:2300, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-01-20 10:00', preferred:true },
    { id:152, name:'新疆纯牛奶200ml*12', model:'MILK-2012', spec:'200ml*12盒', spu:'ZD-A00023', sku:'HZ-A00023-002-DF', jc:true, jcPrice:'¥38.50', jcMoq:100, type:'physical', catL3:'家居 > 食品 > 乳制品', brand:'天润', supplier:'鹏程优品', tags:[4], supplyPrice:'¥42.00', ecomPrice:'¥75.00', stock:1600, warehouse:'华南仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-01-24 14:20' },
    { id:153, name:'有机黑木耳200g', model:'FUNGI-200', spec:'200g', spu:'ZD-A00024', sku:'HZ-A00024-001-DF', type:'physical', catL3:'家居 > 食品 > 干货', brand:'北大荒', supplier:'环球优选', tags:[2,4], supplyPrice:'¥28.00', ecomPrice:'¥49.00', stock:3100, warehouse:'华北仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-03-01 09:30', preferred:true },
    { id:154, name:'有机黑木耳200g', model:'FUNGI-200', spec:'200g', spu:'ZD-A00024', sku:'HZ-A00024-002-DF', type:'physical', catL3:'家居 > 食品 > 干货', brand:'北大荒', supplier:'星辰商贸', tags:[4], supplyPrice:'¥25.00', ecomPrice:'¥45.00', stock:2700, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-03-04 11:00' },
    { id:155, name:'家用便携式榨汁机', model:'JUICE-600', spec:'白色,600ml', spu:'ZD-A00030', sku:'HZ-A00030-001-DF', type:'physical', catL3:'家居 > 电器 > 厨房小电', brand:'美的', supplier:'星辰商贸', tags:[0,2], supplyPrice:'¥89.00', ecomPrice:'¥159.00', stock:1400, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-05-08 13:00', preferred:true },
    { id:156, name:'每日坚果混合礼盒', model:'NUT-750', spec:'750g礼盒', spu:'ZD-A00031', sku:'HZ-A00031-001-DF', type:'physical', catL3:'家居 > 食品 > 坚果炒货', brand:'沃隆', supplier:'环球优选', tags:[2,4], supplyPrice:'¥68.00', ecomPrice:'¥128.00', stock:1900, warehouse:'华北仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-04-15 10:30', preferred:true },
    { id:157, name:'3M 9001V KN95口罩', model:'9001V', spec:'白色,常规', spu:'ZD-A00002', sku:'HZ-A00002-001-DF', type:'physical', catL3:'劳保用品 > 防护口罩 > KN95口罩', brand:'3M', supplier:'星辰商贸', tags:[0,2,4], supplyPrice:'¥16.90', ecomPrice:'¥35.90', stock:6200, warehouse:'华东仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-06-22 10:00', preferred:true },
    // —— 渠道商品(04)在售但池内缺主数据的回填,使渠道商品全部可回溯供应侧 ——
    { id:158, name:'儿童运动跑鞋', model:'KID-RUN3', spec:'28码', spu:'ZD-A00025', sku:'HZ-A00025-001-DF', type:'physical', catL3:'运动户外 > 童鞋 > 运动跑鞋', brand:'安踏儿童', supplier:'鹏程优品', tags:[0,2], supplyPrice:'¥65.00', ecomPrice:'¥119.00', stock:860, warehouse:'华南仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-04-02 10:00', preferred:true },
    { id:159, name:'儿童运动跑鞋', model:'KID-RUN3', spec:'28码', spu:'ZD-A00025', sku:'HZ-A00025-002-DF', type:'physical', catL3:'运动户外 > 童鞋 > 运动跑鞋', brand:'安踏儿童', supplier:'恒通供应链', tags:[2], supplyPrice:'¥58.00', ecomPrice:'¥109.00', stock:430, warehouse:'华东仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-04-08 15:20' },
    { id:160, name:'儿童运动跑鞋', model:'KID-RUN3', spec:'30码', spu:'ZD-A00025', sku:'HZ-A00025-003-DF', type:'physical', catL3:'运动户外 > 童鞋 > 运动跑鞋', brand:'安踏儿童', supplier:'鹏程优品', tags:[0,2], supplyPrice:'¥65.00', ecomPrice:'¥119.00', stock:520, warehouse:'华南仓', shipping:'顺丰/中通', logisticsNote:'24h内发货', createdAt:'2025-04-02 10:05' },
    { id:161, name:'有机绿茶礼盒装', model:'TEA-200', spec:'200g', spu:'ZD-A00026', sku:'HZ-A00026-001-DF', type:'physical', catL3:'食品饮料 > 茶饮冲调 > 绿茶', brand:'八马', supplier:'环球优选', tags:[2,4], supplyPrice:'¥56.00', ecomPrice:'¥99.00', stock:1200, warehouse:'华北仓', shipping:'韵达/中通', logisticsNote:'24h内发货', createdAt:'2025-03-28 09:00', preferred:true },
    { id:162, name:'纳米喷雾补水仪', model:'SPRAY-K9', spec:'标准款', spu:'ZD-A00027', sku:'HZ-A00027-001-DF', type:'physical', catL3:'个护美妆 > 美容仪器 > 补水仪', brand:'金稻', supplier:'鹏程优品', tags:[1,3], supplyPrice:'¥35.00', ecomPrice:'¥69.00', stock:980, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2025-05-12 11:30', preferred:true },
    { id:163, name:'折叠旅行背包', model:'PACK-20L', spec:'20L', spu:'ZD-A00028', sku:'HZ-A00028-001-DF', type:'physical', catL3:'运动户外 > 户外装备 > 背包', brand:'探路者', supplier:'星辰商贸', tags:[0,4], supplyPrice:'¥45.00', ecomPrice:'¥89.00', stock:0, warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'库存耗尽', createdAt:'2025-02-10 14:00', preferred:true },
    { id:164, name:'星巴克电子礼品卡', model:'SBUX-100', spec:'面值100元', spu:'ZDXN-A00006', sku:'HZXN-A00006-001-KM', type:'virtual', catL3:'虚拟商品 > 礼品卡 > 电子卡', brand:'星巴克', supplier:'数字服务商B', tags:[5], supplyPrice:'¥80.00', ecomPrice:'¥95.00', stock:-1, warehouse:'—', shipping:'自动发货', logisticsNote:'即时到账', createdAt:'2025-04-10 10:00', preferred:true },
    { id:165, name:'家庭营养过年礼包', model:'COMBO-002', spec:'组合套装A', spu:'ZDZH-A00002', sku:'HZZH-A00003-001', type:'combo', catL3:'食品饮料 > 乳制品 > 牛奶；节日礼盒 > 春节礼盒 > 食品礼包', brand:'天润', supplier:'恒通供应链', tags:[0,4], supplyPrice:'¥73.00', ecomPrice:'¥99.00', stock:1200, comboComponents:[{role:'主件',qty:1,name:'天润 新疆纯牛奶200ml*12'},{role:'搭配件',qty:1,name:'北大荒 有机黑木耳200g'}], warehouse:'华东仓', shipping:'中通/圆通', logisticsNote:'24h内发货', createdAt:'2026-01-15 10:00', preferred:true },
  ],
  ...
  jicaiQuotes: [
    {
      ...
      items: [
        ...
        { mallSku: 'S001A00023001', name: '天润 新疆纯牛奶200ml*12 MILK-2012 200ml*12盒', spec: '200ml*12盒', qty: 200, costPrice: 38.5, refPrice: 75, agreePrice: 48, deliveryDays: 7, supplier: '鹏程优品', supplySku: 'HZ-A00023-002-JC' }
      ]
    },
    {
  ...
  pricingSkus: [
    { spu: '富光 不锈钢保温杯500ml', spuName: '富光 不锈钢保温杯500ml', spuCode: 'ZD-A00004', spuThumb: '富光',
      skus: [
        ...
        { id: 'HZ-A00004-003-DF', spec: '白色,500ml', supply: 33, ecom: 65, channelPrice: '', channelPrices: {}, strikePrice: '', strikePrices: {}, mallPrice: '', mallPrices: {}, edited: false },
      ]
    },
    { spu: '波司登 加厚保暖羽绒服', spuName: '波司登 加厚保暖羽绒服', spuCode: 'ZD-A00008', spuThumb: '波司',
      skus: [
        ...
        { id: 'HZ-A00008-003-DF', spec: '黑色,XL', supply: 175, ecom: 349, channelPrice: '', channelPrices: {}, strikePrice: '', strikePrices: {}, mallPrice: '', mallPrices: {}, edited: false },
    ...
    { spu: '奥康 男士商务休闲皮鞋', spuName: '奥康 男士商务休闲皮鞋', spuCode: 'ZD-A00006', spuThumb: '奥康',
      skus: [
        ...
        { id: 'HZ-A00006-002-DF', spec: '棕色,42码', supply: 105, ecom: 269, channelPrice: '', channelPrices: {}, strikePrice: '', strikePrices: {}, mallPrice: '', mallPrices: {}, edited: false },
  ...
  pendingData: [
    ...
    { id:3, type:'conflict', typeLabel:'渠道冲突', product:'夏季纯棉圆领T恤', brand:'森马', spec:'白色,M', sku:'HZ-A00009-001-DF', mallSku:'S001A00002001', channel:'锦程员工福利商城', supplier:'星辰商贸', supplyPrice:'¥85.00', channelPrice:'¥129.00', reason:'商城 [锦程员工福利商城] 已存在同款在售 (供应链SKU: HZ-A00009-002-DF)', actions:['compare','cancelList'], time:'2026-05-13 16:48', sourceType:'清单推品' },
    { id:4, type:'supplier', typeLabel:'供应商优化', product:'智能蓝牙体脂秤', brand:'小米', spec:'白色', sku:'HZ-A00003-001-DF', mallSku:'S001A00003001', channel:'锦程员工福利商城', supplier:'恒通供应链', supplyPrice:'¥95.00', channelPrice:'¥189.00', reason:'存在更低价供应商星辰商贸HZ-A00003-002-DF (供货价：¥90)，当前差价 ¥5', actions:['switch','approval'], time:'2026-05-13 09:30', sourceType:'渠道导入' },
    ...
    { id:9, type:'codeConflict', typeLabel:'编码冲突', product:'3M 9001V KN95口罩', brand:'3M', spec:'蓝色,常规', sku:'HZ-A00002-001-DF', mallSku:'S001A00001001', channel:'锦程员工福利商城', supplier:'星辰商贸', supplyPrice:'¥16.80', channelPrice:'¥129.00', reason:'供应链同款组 SAME-MASK-004 关联了2个不同的商城SPU。主SPU: S001A00001 "3M 9001V KN95口罩"，冲突SPU: S001A00002 "3M口罩9001V蓝"。建议将冲突SPU并入主SPU', actions:['confirmMerge','ignore'], time:'2026-06-26 08:30', sourceType:'存量巡检' },
    ...
    { id:18, type:'supplier', typeLabel:'供应商优化', product:'加厚保暖羽绒服', brand:'波司登', spec:'藏青,XXL', sku:'HZ-A00008-004-DF', mallSku:'S001A00012001', channel:'锦程积分商城', supplier:'环球优选', supplyPrice:'¥200.00', channelPrice:'¥399.00', reason:'存在更低价供应商恒通供应链HZ-A00008-003-DF (供货价：¥175)，当前差价 ¥25', actions:['switch','approval'], time:'2026-06-17 15:00', sourceType:'渠道导入' },
    ...
    { id:21, type:'supplier', typeLabel:'供应商优化', product:'有机山茶油500ml', brand:'金龙鱼', spec:'500ml', sku:'HZ-A00015-001-DF', mallSku:'S001A00013001', channel:'泡泡玛特官方商城', supplier:'恒通供应链', supplyPrice:'¥30.00', channelPrice:'¥59.00', reason:'存在更低价供应商星辰商贸HZ-A00015-002-DF (供货价：¥27)，当前差价 ¥3', actions:['switch','approval'], time:'2026-06-28 10:30', sourceType:'存量巡检' },
    { id:22, type:'supplier', typeLabel:'供应商优化', product:'新疆纯牛奶200ml*12', brand:'天润', spec:'200ml*12盒', sku:'HZ-A00023-001-DF', mallSku:'C001A00001001', channel:'泡泡玛特官方商城', supplier:'恒通供应链', supplyPrice:'¥45.00', channelPrice:'¥79.00', reason:'组合商品[天润 家庭营养过年礼包 组合套装A]子件[新疆纯牛奶]存在更低价供应商鹏程优品HZ-A00023-002-DF (供货价：¥42)，当前差价 ¥3', actions:['switch','approval'], time:'2026-07-05 09:15', sourceType:'存量巡检' },
    { id:23, type:'supplier', typeLabel:'供应商优化', product:'有机黑木耳200g', brand:'北大荒', spec:'200g', sku:'HZ-A00024-001-DF', mallSku:'C002A00001001', channel:'锦程员工福利商城', supplier:'环球优选', supplyPrice:'¥28.00', channelPrice:'¥49.00', reason:'组合商品[北大荒 养生食材礼盒 组合套装B]子件[有机黑木耳]存在更低价供应商星辰商贸HZ-A00024-002-DF (供货价：¥25)，当前差价 ¥3', actions:['switch','approval'], time:'2026-07-04 14:30', sourceType:'清单推品' },
    { id:24, type:'conflict', typeLabel:'渠道冲突', product:'家用便携式榨汁机', brand:'美的', spec:'白色,600ml', sku:'HZ-A00030-001-DF', mallSku:'S001A00016001', channel:'泡泡玛特官方商城', supplier:'星辰商贸', supplyPrice:'¥89.00', channelPrice:'¥159.00', reason:'该商品已在商城 [泡泡玛特官方商城] 上架在售 (SKU: HZ-A00030-001-DF)，本次为重复推品，请复查是否需改价或调整', actions:['compare','cancelList'], time:'2026-07-29 10:20', sourceType:'清单推品' },
    { id:25, type:'conflict', typeLabel:'渠道冲突', product:'每日坚果混合礼盒', brand:'沃隆', spec:'750g礼盒', sku:'HZ-A00031-001-DF', mallSku:'S001A00017001', channel:'锦程员工福利商城', supplier:'环球优选', supplyPrice:'¥68.00', channelPrice:'¥128.00', reason:'该商品已在商城 [锦程员工福利商城] 上架在售 (SKU: HZ-A00031-001-DF)，本次为重复推品，请复查是否需改价或调整', actions:['compare','cancelList'], time:'2026-07-28 15:45', sourceType:'清单推品' }
  ],
  ...
  pendingSupplierRef: {
    ...
    'HZ-A00023-001-DF': { // 新疆纯牛奶200ml*12（组合商品子件）
      spuCode: 'S023A00001',
      spec: '200ml*12盒',
      selectedSupplier: '恒通供应链',
      selectedPrice: '¥45.00',
    ...
    'HZ-A00024-001-DF': { // 有机黑木耳200g（组合商品子件）
      spuCode: 'S024A00001',
      spec: '200g',
      selectedSupplier: '环球优选',
      selectedPrice: '¥28.00',
  ...
  channelProducts: [
    ...
    { id:'p2', name:'男士商务休闲皮鞋', spu:'S001A00006', supplySpu:'ZD-A00006', type:'physical', supplyPrice:'¥100', totalStock:75, tags:[{label:'品质优选',cls:'tag-green'}],
      skus: [
        { sku:'S001A00006001', spec:'黑色42码', channels: [
          { ch:'锦程员工福利商城', price:'¥90', supplier:'恒通供应链', logistics:'顺丰 - 48h', sellable:'on' },
          { ch:'苏银商城', price:'¥88', supplier:'恒通供应链', logistics:'顺丰 - 48h', sellable:'on' },
        ]}
      ]
    },
    { id:'p3',name:'家庭营养过年礼包', spu:'C001A00001', supplySpu:'ZDZH-A00002', type:'combo', supplyPrice:'¥73', totalStock:1200, tags:[{label:'新品推荐',cls:'tag-orange'},{label:'员工福利',cls:'tag-green'}],
      skus: [
    ...
    { id:'p6', name:'儿童运动跑鞋', spu:'S001A00007', supplySpu:'ZD-A00025', type:'physical', supplyPrice:'¥65', totalStock:463, tags:[{label:'最优性价比',cls:'tag-green'}],
      skus: [
        { sku:'S001A00007001', spec:'28码', channels: [
          ...
          { ch:'苏银商城', price:'¥58', supplier:'恒通供应链', logistics:'韵达/中通 - 24h', sellable:'on' },
        ]},
    ...
    { id:'p7', name:'女士直筒休闲长裤', spu:'S001A00005', supplySpu:'ZD-A00005', type:'physical', supplyPrice:'¥95', totalStock:230, tags:[{label:'稳定供货',cls:'tag-green'},{label:'品质优选',cls:'tag-green'}],
      skus: [
        { sku:'S001A00005001', spec:'S码', channels: [
          ...
          { ch:'苏银商城', price:'¥95', supplier:'恒通供应链', logistics:'韵达/中通 - 24h', sellable:'on' },
        ]}
      ]
    },
    ...
    { id:'p9', name:'有机绿茶礼盒装', spu:'S001A00009', supplySpu:'ZD-A00026', type:'physical', supplyPrice:'¥56', totalStock:560, tags:[{label:'品质优选',cls:'tag-green'},{label:'产地直供',cls:'tag-green'}],
      skus: [
    ...
    { id:'p10', name:'纳米喷雾补水仪', spu:'S001A00010', supplySpu:'ZD-A00027', type:'physical', supplyPrice:'¥35', totalStock:166, tags:[{label:'限时特惠',cls:'tag-red'}],
      skus: [
        { sku:'S001A00010001', spec:'标准款', channels: [
          ...
          { ch:'苏银商城', price:'¥72', supplier:'鹏程优品', logistics:'韵达/中通 - 24h', sellable:'off' },
        ]}
      ]
    },
    { id:'p11',name:'折叠旅行背包', spu:'S001A00011', supplySpu:'ZD-A00028', type:'physical', supplyPrice:'¥45', totalStock:0, tags:[{label:'新品上市',cls:'tag-blue'}],
      skus: [
  ...
  productDetail: {
    spu: {
      ...
      supplySPUs:['ZD-A00001','ZD-A00002'],
    ...
    skus: {
      sku1: {
        ...
        supplySKUs:['HZ-A00001-001-DF','HZ-A00001-001-DF'],
        ...
        suppliers:[
          {id:'supA',name:'星辰商贸',supName:'3M 9001V KN95防护口罩',supModel:'9001V',supplySKU:'HZ-A00001-001-DF',preferred:true,preferredReason:'年度框架协议合作方，交付准时率99.2%，近6个月零断供；含48小时必达SLA，账期T+30优于行业平均。',barcode:'6901234567890',supplyPrice:'15.00',jcPrice:'13.50',moq:100,stock:5000,leadTime:'3天',settlement:'现款现货',supplyMode:'一件代发+集采直发',shipping:'顺丰/中通',region:'全国',contact:'王经理 13800001111',status:'合作中',refPrice:'129.00',refPlatform:'天猫',ecomLink:'tmall.com/xxx',hasImage:true,hasParams:true,hasDetail:true,imageSelected:true,note:'',orderVolume:'12,800',afterSale:'2.1%'},
          {id:'supD',name:'环球优选',supName:'3M 9001V 防雾霾口罩（耳戴式）',supModel:'9001V-CN',supplySKU:'HZ-A00001-001-DF',barcode:'6901234567892',supplyPrice:'14.00',moq:200,stock:8000,leadTime:'2天',settlement:'月结30天',supplyMode:'一件代发',shipping:'京东物流',region:'华东/华南',contact:'赵主管 13900002222',status:'合作中',refPrice:'135.00',refPlatform:'京东',ecomLink:'jd.com/xxx',hasImage:true,hasParams:false,hasDetail:true,imageSelected:false,note:'',orderVolume:'8,500',afterSale:'3.5%'}
        ]
      },
      sku2: {
        code:'S001A00001002', spec:'蓝,常规', barcode:'6901234567891',
        supplySKUs:['HZ-A00001-002-DF','HZ-A00001-002-DF'],
        ...
        suppliers:[
          {id:'supA2',name:'星辰商贸',supName:'3M 9001V KN95防护口罩',supModel:'9001V',supplySKU:'HZ-A00001-002-DF',preferred:true,preferredReason:'年度框架协议合作方，交付准时率99.2%，近6个月零断供；含48小时必达SLA，账期T+30优于行业平均。',barcode:'6901234567893',supplyPrice:'16.00',jcPrice:'14.50',moq:100,stock:3200,leadTime:'3天',settlement:'现款现货',supplyMode:'一件代发+集采直发',shipping:'顺丰/中通',region:'全国',contact:'王经理 13800001111',status:'合作中',refPrice:'139.00',refPlatform:'天猫',ecomLink:'tmall.com/xxx',hasImage:true,hasParams:true,hasDetail:true,imageSelected:true,note:'',orderVolume:'9,200',afterSale:'2.4%'},
          {id:'supE',name:'数字服务商A',supName:'3M 9001V 灰蓝色 KN95 口罩',supModel:'9001V-BL',supplySKU:'HZ-A00001-002-DF',barcode:'6901234567895',supplyPrice:'13.50',moq:300,stock:12000,leadTime:'5天',settlement:'账期60天',supplyMode:'一件代发',shipping:'圆通/韵达',region:'全国',contact:'钱总 13700003333',status:'合作中',refPrice:'—',refPlatform:'—',ecomLink:'—',hasImage:false,hasParams:true,hasDetail:false,imageSelected:false,note:'',orderVolume:'15,400',afterSale:'4.8%'}
        ]
      },
      sku3: {
        code:'S001A00001003', spec:'灰,加厚', barcode:'6901234567896',
        supplySKUs:['HZ-A00002-001-DF','HZ-A00002-001-DF','HZ-A00002-001-DF','HZ-A00002-001-DF','HZ-A00002-001-DF'],
        ...
        suppliers:[
          {id:'supB',name:'恒通供应链',supName:'3M 9001V 灰色加厚版 KN95 口罩',supModel:'9001V-THICK',supplySKU:'HZ-A00002-001-DF',preferred:true,preferredReason:'华南区域核心供应商，仓库覆盖广；24小时极速发货，紧急补货首选；与OPPO/华为等品牌深度合作，品控稳定。',barcode:'6901234567001',supplyPrice:'18.00',moq:50,stock:3000,leadTime:'2天',settlement:'现款现货',supplyMode:'一件代发',shipping:'顺丰',region:'全国',contact:'刘经理 13600001112',status:'合作中',refPrice:'149.00',refPlatform:'天猫',ecomLink:'tmall.com/xxx',hasImage:true,hasParams:true,hasDetail:true,imageSelected:false,note:'',orderVolume:'6,300',afterSale:'1.8%'},
          {id:'supC',name:'鹏程优品',supName:'3M 9001V 灰色 KN95 防尘口罩',supModel:'9001V-GR',supplySKU:'HZ-A00002-001-DF',barcode:'6901234567002',supplyPrice:'17.50',moq:100,stock:5000,leadTime:'3天',settlement:'月结30天',supplyMode:'一件代发',shipping:'中通/圆通',region:'华东',contact:'陈主管 13500002223',status:'合作中',refPrice:'145.00',refPlatform:'京东',ecomLink:'jd.com/xxx',hasImage:true,hasParams:false,hasDetail:true,imageSelected:false,note:'',orderVolume:'11,500',afterSale:'3.0%'},
          {id:'supF',name:'数字服务商B',supName:'3M 9001V 加厚防尘口罩 KN95',supModel:'9001V-PRO',supplySKU:'HZ-A00002-001-DF',barcode:'6901234567003',supplyPrice:'16.80',moq:200,stock:8000,leadTime:'1天',settlement:'现款现货',supplyMode:'一件代发',shipping:'京东物流',region:'全国',contact:'周经理 13800003334',status:'合作中',refPrice:'139.00',refPlatform:'拼多多',ecomLink:'pdd.com/xxx',hasImage:false,hasParams:true,hasDetail:false,imageSelected:false,note:'价格最优',orderVolume:'22,000',afterSale:'4.2%'},
          {id:'supG',name:'中远商贸',supName:'3M 9001V 加厚工业防护口罩',supModel:'9001V-IND',supplySKU:'HZ-A00002-001-DF',barcode:'6901234567004',supplyPrice:'19.00',moq:500,stock:15000,leadTime:'7天',settlement:'账期45天',supplyMode:'一件代发',shipping:'顺丰/中通',region:'华南',contact:'吴总 13700004445',status:'已暂停',refPrice:'—',refPlatform:'—',ecomLink:'—',hasImage:true,hasParams:false,hasDetail:false,imageSelected:false,note:'供货不稳定',orderVolume:'3,100',afterSale:'6.5%'},
          {id:'supH',name:'蓝海供应链',supName:'3M 9001V 灰色加厚口罩（GB2626）',supModel:'9001V-H',supplySKU:'HZ-A00002-001-DF',barcode:'6901234567005',supplyPrice:'17.00',moq:150,stock:6000,leadTime:'4天',settlement:'月结60天',supplyMode:'一件代发',shipping:'韵达',region:'华北',contact:'郑经理 13900005556',status:'合作中',refPrice:'142.00',refPlatform:'天猫',ecomLink:'tmall.com/xxx',hasImage:true,hasParams:true,hasDetail:true,imageSelected:false,note:'',orderVolume:'4,800',afterSale:'2.5%'}
        ]
      },
      sku4: {
      ...
      sku5: {
        ...
        supplySKUs:['HZ-A00001-001-DF','HZ-B00002-001-DF','HZ-D00004-001-DF'],
        components:[
          {mallSku:'S001A00001001',supplySKUs:['HZ-A00001-001-DF','HZ-A00001-001-DF'],name:'3M 9001V KN95口罩',spec:'{白,常规}',supplier:'恒通供应链',qty:1,role:'主件',supplyPrice:'15.00',supplyMode:'manual',designated:true,designatedSupplier:'恒通供应链',altSuppliers:[{name:'恒通供应链',price:'15.00',shipping:'顺丰/中通',orderVolume:'12,800',afterSale:'2.1%',settlement:'现款现货',status:'合作中'},{name:'环球优选',price:'14.00',shipping:'京东物流',orderVolume:'8,500',afterSale:'3.5%',settlement:'月结30天',status:'合作中'}],stock:5000,refPrice:'129.00',refPlatform:'天猫',ecomLink:'tmall.com/xxx',leadTime:'3天',shipping:'顺丰/中通',region:'全国',status:'合作中',hasImage:true},
    ...
    channels: [
      {id:'ch1',channel:'汇通内购平台',skuSpec:'{白,常规}',mode:'直销',supplyPrice:'15.00',linePrice:'129.00',channelPrice:'15.00',mallPrice:'18.00',myMargin:'20%',chMargin:'—',listedDate:'2026-03-20 10:00',listedBy:'李四 (商城运营端)',sellable:'on',locked:false,skuKey:'sku1',supplyMode:'lowest',designatedSupplier:null,oaPending:false,totalOrders:12470,recentOrders:1128,totalAfterSale:'4.5%',recentAfterSale:'3.1%',firstOrderDate:'2026-03-22'},
      {id:'ch2',channel:'蜀味员工专区',skuSpec:'{白,常规}',mode:'分销',supplyPrice:'15.00',linePrice:'129.00',channelPrice:'20.00',mallPrice:'25.00',myMargin:'33%',chMargin:'25%',listedDate:'2026-04-10 09:00',listedBy:'张三 (商城运营端)',sellable:'off',locked:true,lockedReason:'供应商已调价，请在待处理选品中心处理',skuKey:'sku1',supplyMode:'manual',designatedSupplier:'supA',oaPending:false,totalOrders:389,recentOrders:42,totalAfterSale:'12.8%',recentAfterSale:'15.2%',firstOrderDate:'2026-04-12'},
      {id:'ch3',channel:'长江科技福利商城',skuSpec:'{蓝,常规}',mode:'分销',supplyPrice:'13.50',linePrice:'129.00',channelPrice:'18.00',mallPrice:'22.00',myMargin:'28%',chMargin:'22%',listedDate:'2026-05-15 11:00',listedBy:'王五 (商城运营端)',sellable:'on',locked:false,skuKey:'sku2',supplyMode:'lowest',designatedSupplier:null,oaPending:false,totalOrders:560,recentOrders:114,totalAfterSale:'3.2%',recentAfterSale:'2.8%',firstOrderDate:'2026-05-16'},
      ...
      {id:'ch5',channel:'蜀味员工专区',skuSpec:'工业防护专业套装',mode:'分销',supplyPrice:'64.00',linePrice:'129.00',channelPrice:'78.00',mallPrice:'99.00',myMargin:'35%',chMargin:'27%',listedDate:'2026-07-01 10:00',listedBy:'李四 (商城运营端)',sellable:'on',locked:false,skuKey:'sku5',supplyMode:'manual',designatedSupplier:null,oaPending:false,totalOrders:85,recentOrders:22,totalAfterSale:'0.5%',recentAfterSale:'—',firstOrderDate:'2026-07-02'}
    ],
    logs: [
      {date:'2026-06-02',time:'14:30',type:'改价',dot:'yellow',actor:'系统 (商城运营端)',content:'[汇通内购平台] SKU S001A00001001 {白,常规} 改价审批通过，商品恢复可售',change:'商城价 ¥15.00 → ¥18.00',result:'success',resultText:'成功'},
      ...
      {date:'2026-03-20',time:'10:00',type:'渠道上架',dot:'green',actor:'李四 (商城运营端)',content:'商品上架至 [汇通内购平台] — SKU S001A00001001 {白,常规} / 星辰商贸 ¥15.00',change:'销售模式=直销 | 商城价=¥18.00',result:'success',resultText:'成功'},
      {date:'2026-03-15',time:'08:00',type:'商品创建',dot:'gray',actor:'系统 (商城运营端)',content:'商城SPU S001A00001 首次创建，关联供应链SPU: ZD-A00001（星辰商贸·3M 9001V KN95防护口罩）, ZD-A00002（环球优选·3M 9001V 防雾霾口罩）共2个',change:'商品类型=实物商品 | 含营销SKU',result:'success',resultText:'成功'},
