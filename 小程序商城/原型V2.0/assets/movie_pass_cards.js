/**
 * 次卡静态演示数据（对接接口后可改为请求结果）。为两端「我的卡券」mock 的并集，与 PC 端保持一致。
...
var MOVIE_PASS_CARDS = [
  {
    id: 'mv1',
    listSubtitle: '苏银豆联名 · 尾号 9021',
    listMeta: '剩余 3 次 · 有效期至 2027-09-30',
    status: 'normal',
    name: '万达影城·观影次卡',
    batchCardName: '万达影城 5 次观影次卡',
    cardNo: 'MV-2026-08-9021****',
    total: 5,
    perUseLimit: 39.9,
    used: 2,
    remain: 3,
    expireText: '2027-09-30 23:59',
    creditedAt: '2026-08-01 10:00',
    scope: '合作影院在线选座购票',
    statusDetail: '正常 · C端已到账',
    desc: '当前持有「万达影城·观影次卡」，可在合作影院在线选座扣次；有效期至 2027-09-30。',
    usageRule: '限合作影院在线选座购票使用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥39.9（不超过单张票价，超出部分现金补足）；单笔订单最多扣 2 次（按实际出票张数折算）；与优惠券/礼品卡三选一，可与苏银豆叠加；不可提现、不可转赠。',
    maxSingleUseSpec: '单笔订单最多扣 2 次（按实际出票张数折算）',
    maxSingleUseAmountText: '¥79.8/单',
    usages: [
      { time: '2026-08-09 19:30', desc: '万达影城（CBD店）·《流浪地球3》·2 张', deductLabel: '扣 2 次' }
    ]
  },
  {
    id: 'mv2',
    listSubtitle: '送洗服务 · 尾号 6633',
    listMeta: '剩余 2 次 · 有效期至 2027-06-30',
    status: 'normal',
    name: '苏银豆商城·送洗服务次卡',
    batchCardName: '苏银豆商城 4 次送洗服务次卡',
    cardNo: 'MV-2026-07-6633****',
    total: 4,
    perUseLimit: 29.9,
    used: 2,
    remain: 2,
    expireText: '2027-06-30 23:59',
    creditedAt: '2026-07-20 16:40',
    scope: '合作洗衣门店通用',
    statusDetail: '正常 · C端已到账',
    desc: '当前持有「苏银豆商城·送洗服务次卡」，可在合作洗衣门店核销使用；有效期至 2027-06-30。',
    usageRule: '限合作洗衣门店通用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥29.9（超出部分现金补足）；单笔订单最多扣 2 次；与优惠券/礼品卡三选一，可与苏银豆叠加；不可提现、不可转赠。',
    maxSingleUseSpec: '单笔订单最多扣 2 次',
    maxSingleUseAmountText: '¥59.8/单',
    usages: [
      { time: '2026-08-02 10:15', desc: 'UCC国际洗衣（建邺店）·衬衫洗涤 2 件', deductLabel: '扣 1 次' },
      { time: '2026-07-25 16:00', desc: 'UCC国际洗衣（江宁店）·外套洗护 1 件', deductLabel: '扣 1 次' }
    ]
  },
  {
    id: 'mv3',
    listSubtitle: '饮品次卡 · 尾号 7745',
    listMeta: '共 6 次已用尽 · 2026-08-31 到期',
    status: 'exhausted',
    name: '星巴克·饮品次卡',
    batchCardName: '星巴克 6 次饮品次卡',
    cardNo: 'MV-2026-05-7745****',
    total: 6,
    perUseLimit: 35,
    used: 6,
    remain: 0,
    expireText: '2026-08-31 23:59',
    creditedAt: '2026-05-12 09:10',
    scope: '星巴克门店通用',
    statusDetail: '已用尽',
    desc: '该卡 6 次已全部使用完毕，仅可查看历史记录；到期后卡片将自动归档。',
    usageRule: '限星巴克门店通用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥35（不超过单张售价，超出部分现金补足）；单笔订单最多扣 2 次；与优惠券/礼品卡三选一，可与苏银豆叠加；不可提现、不可转赠。',
    maxSingleUseSpec: '单笔订单最多扣 2 次',
    maxSingleUseAmountText: '¥70/单',
    usages: [
      { time: '2026-07-01 09:20', desc: '星巴克（河西店）·大杯拿铁 ×2', deductLabel: '扣 2 次' },
      { time: '2026-06-14 15:40', desc: '星巴克（新街口店）·大杯美式 ×2', deductLabel: '扣 2 次' },
      { time: '2026-05-30 11:05', desc: '星巴克（河西店）·中杯卡布奇诺 ×2', deductLabel: '扣 2 次' }
    ]
  },
  {
    id: 'mv4',
    ...
    usageRule: '限合作影院在线选座使用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥35（不超过单张票价，超出部分现金补足）；单笔订单最多扣 2 次（2 张票即扣 2 次）；与优惠券/礼品卡三选一，可与苏银豆叠加；不可提现、不可转赠；退票成功后次数按平台规则退回。',
  ...
  },
  {
    ...
    usageRule: '仅首单/新客可领；限指定城市合作影院；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥30（不超过单张票价，超出部分现金补足）；每自然日最多使用 2 次；到期未用完次数作废；不可提现、不可转赠。',
    maxSingleUseSpec: '单笔订单最多扣 2 次',
  ...
  },
  {
    ...
    usageRule: '限同城合作影院适用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥45（不超过单张票价，超出部分现金补足）；单笔订单最多扣 2 次（一场两人票可一次扣完）；到期未用完次数作废；不可提现、不可转赠。',
  ...
  },
  {
    ...
    usageRule: '全国合作影院通用；1次抵1件，按本单匹配数量核销；单次抵扣上限 ¥60（不超过单张票价，超出部分现金补足）；IMAX/特殊厅按页面公示倍数计次；单日最多扣 4 次；与优惠券/礼品卡三选一，可与苏银豆叠加；不可提现、不可转赠。',
